        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-6">
          {steps.map((step, idx) => (
            ...
            >
              ...
              <h3 className="text-md font-bold text-gray-800 mb-2">{step.title}</h3>
        ...
        <div className="mt-12">
          <p className="text-lg font-medium text-gray-700">
            ...
            <span className="text-themeGreen font-semibold ml-1 underline cursor-pointer">
              <button className='border rounded-3xl bg-themeGreen text-white px-4'> Book Appointment Now</button>
            </span>
          </p>
        </div>
      </div>
