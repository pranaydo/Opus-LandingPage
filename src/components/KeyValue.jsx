...
//   <Layers className="w-6 h-6 text-themeLight mt-1" />
...
//       {/* Point 3 */}
//       <div className="flex items-start gap-4 bg-white border-4 border-gray-200 p-4 rounded-lg shadow-sm max-w-md w-full mx-auto">
//         <ScanLine className="w-6 h-6 text-themeLight mt-1" />
//         <p className="text-gray-700 font-medium">
...
//       {/* Point 4 */}
//       <div className="flex items-start gap-4 bg-white border-4 border-gray-200 p-4 rounded-lg shadow-sm max-w-md w-full mx-auto">
//         <MapPin className="w-6 h-6 text-themeLight mt-1" />
//         <p className="text-gray-700 font-medium">
...
//           {/* Card 1 */}
//           <div className="flex items-start gap-4 bg-white text-gray-800 border-4 border-gray-200 p-4 rounded-lg shadow-sm transition duration-300 transform hover:scale-105 hover:bg-themeLight hover:text-white">
  ...
  return (
    <section className="w-full bg-darkGray px-4 sm:px-6 md:px-12 py-16">
      <div className="max-w-7xl mx-auto">
        {/* Section Heading */}
        <h2 className="text-2xl sm:text-3xl font-bold text-center text-themeLight mb-10">
